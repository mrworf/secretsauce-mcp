...
export const CONTROL_NAVIGATION: readonly NavigationItem[] = [
  ...
  { label: "Activity", path: "/activity", description: "Operational activity", capability: "configure_service", group: "Operations" },
  { label: "MCP audit", path: "/mcp-audit", description: "Runtime audit events", capability: "configure_service", group: "Operations" },
  { label: "Administrative audit", path: "/administrative-audit", description: "Control-plane audit events", capability: "configure_service", group: "Operations" },
