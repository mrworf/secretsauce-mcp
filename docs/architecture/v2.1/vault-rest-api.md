...
- **Governing requirements:** `VAULTAPI-001` through `VAULTAPI-007`
...
binding, replay, caller-substitution, cross-caller authorization, and
secret-free diagnostics tests.
