...
Automated evidence below was collected from executable candidate `1768357` on
2026-07-28 using Node 26.4.0 on linux/x86_64. The M10 planning commit changes
only milestone documentation. Later evidence commits must state whether they
change executable product behavior; any such change creates a new candidate
