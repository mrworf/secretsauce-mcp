...
const patchSchema = z.object({
  ...
  automatic_suspension_threshold: integer.min(3).max(20).nullable().optional(),
...
const settingsSchema = z.object({
  ...
  automatic_suspension_threshold: integer.min(3).max(20).nullable(),
...
function patchFromWire(
  ...
  const mapping = {
    ...
    automatic_suspension_threshold: "automaticSuspensionThreshold",
...
function wireSettings(value: ReturnType<SecuritySettingsStore["current"]>) {
  return {
    ...
    automatic_suspension_threshold: value.automaticSuspensionThreshold,
